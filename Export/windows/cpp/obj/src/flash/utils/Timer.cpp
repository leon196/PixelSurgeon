...
{
HX_STACK_FRAME("flash.utils.Timer","new",0xc4d93bdc,"flash.utils.Timer.new","flash/utils/Timer.hx",21,0xdf0cfbd6)
...
int repeatCount = __o_repeatCount.Default(0);
{
	...
	if (((  ((!(::Math_obj::isNaN(delay)))) ? bool((delay < (int)0)) : bool(true) ))){
		HX_STACK_LINE(25)
		HX_STACK_DO_THROW(::flash::errors::Error_obj::__new(HX_CSTRING("The delay specified is negative or not a finite number"),null()));
	}
	HX_STACK_LINE(29)
...
{
		HX_STACK_FRAME("flash.utils.Timer","reset",0xe81c8c4b,"flash.utils.Timer.reset","flash/utils/Timer.hx",38,0xdf0cfbd6)
		HX_STACK_THIS(this)
		HX_STACK_LINE(40)
		if ((this->running)){
			HX_STACK_LINE(42)
...
{
		HX_STACK_FRAME("flash.utils.Timer","start",0x855fb6de,"flash.utils.Timer.start","flash/utils/Timer.hx",53,0xdf0cfbd6)
		HX_STACK_THIS(this)
		HX_STACK_LINE(53)
		if ((!(this->running))){
			HX_STACK_LINE(55)
...
Void Timer_obj::stop( ){
{
		HX_STACK_FRAME("flash.utils.Timer","stop",0x7c949106,"flash.utils.Timer.stop","flash/utils/Timer.hx",64,0xdf0cfbd6)
		HX_STACK_THIS(this)
		HX_STACK_LINE(66)
		this->running = false;
		HX_STACK_LINE(68)
...
Float Timer_obj::get_delay( ){
	HX_STACK_FRAME("flash.utils.Timer","get_delay",0x2e1d6456,"flash.utils.Timer.get_delay","flash/utils/Timer.hx",87,0xdf0cfbd6)
	HX_STACK_THIS(this)
	HX_STACK_LINE(87)
	return this->__delay;
}
...
Float Timer_obj::set_delay( Float value){
	HX_STACK_FRAME("flash.utils.Timer","set_delay",0x116e5062,"flash.utils.Timer.set_delay","flash/utils/Timer.hx",92,0xdf0cfbd6)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flash.utils.Timer","timer_onTimer",0xfdd362e8,"flash.utils.Timer.timer_onTimer","flash/utils/Timer.hx",115,0xdf0cfbd6)
		HX_STACK_THIS(this)
		HX_STACK_LINE(117)
		(this->currentCount)++;
		HX_STACK_LINE(119)
