...
Void FPS_obj::this_onEnterFrame( ::flash::events::Event event){
{
		...
		HX_STACK_LINE(58)
		this->currentFPS = ::Math_obj::round((Float(((currentCount + this->cacheCount))) / Float((int)2)));
		HX_STACK_LINE(60)
...
void FPS_obj::__Mark(HX_MARK_PARAMS)
{
	...
	::flash::text::TextField_obj::__Mark(HX_MARK_ARG);
	HX_MARK_END_CLASS();
}
...
void FPS_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	::flash::text::TextField_obj::__Visit(HX_VISIT_ARG);
}
