...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("", "PixelSurgeon", "fr.leon", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Pixel Surgeon Prototype", null, { width: 800, height: 600 });
